/*
	I look at all horizontal lines.
	If they are less than sqrt(n) points then we can just check for
	every pair of them whether they form a pair.
	Else we check all points if they can form a square with one side on this line.
	I used unordered_set to improve the time.
*/
#include <bits/stdc++.h>
